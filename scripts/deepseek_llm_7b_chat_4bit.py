#!/usr/bin/env python
"""
Deepseek LLM 7B Chat Inference Script (4-bit)
Connects to a local quantized Deepseek LLM 7B Chat model and generates text.

Usage:
    python scripts/deepseek_llm_7b_chat_4bit.py "Your prompt here"

Requirements:
    pip install transformers accelerate bitsandbytes
    (Make sure you have a 4-bit quantized checkpoint, e.g. TheBloke/deepseek-llm-7B-chat-GPTQ)
"""
import sys
import os
from transformers import AutoTokenizer, AutoModelForCausalLM, BitsAndBytesConfig

MODEL_NAME = "TheBloke/deepseek-llm-7B-chat-GPTQ"  # Change to your preferred Q4 checkpoint
...
def main():
    ...
    print(f"Loading Deepseek LLM 7B Chat (4-bit) model: {MODEL_NAME} ...")
    t0 = time.time()
